...
{{ image(src="/img/ai-agents/summary-first-pr-0.webp",
...
{{ figure(src="/img/ai-agents/walkthrough-first-pr.webp",
...
{{ image(src="/img/ai-agents/summary-first-pr-1.webp",
...
{{ figure(src="/img/ai-agents/sequence-diagram.webp",
...
{{ figure(src="/img/ai-agents/coderabbitai-commit-emoji.webp",
...
{{ image(src="/img/ai-agents/correct-typo-second-pr.webp",
...
{{ figure(src="/img/ai-agents/activity-dashboard.webp",
          caption="Activity dashboard showing engagment with CodeRabbitAI",
          caption_style="font-weight: bold; font-style: italic;",
          style="border-radius: 8px;") }}

{{ figure(src="/img/ai-agents/adoption-dashboard.webp",
          caption="Dashboard showing overall adoption of CodeRabbitAI on the projects",
          caption_style="font-weight: bold; font-style: italic;",
          style="border-radius: 8px;") }}

{{ figure(src="/img/ai-agents/findings-dashboard.webp",
